...
function createArchive(members, output, exportDir) {
  if (process.platform === "win32") {
    const command = "$files = [string[]](ConvertFrom-Json -InputObject $env:SESSION_CURATE_FILES); Compress-Archive -LiteralPath $files -DestinationPath $env:SESSION_CURATE_OUTPUT -CompressionLevel Optimal";
